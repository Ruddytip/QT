...
void MainWindow::changeLangue(enum class LNG dir){
    ...
    ui->Theme->setTitle(str[15]);
    ui->Light->setText(str[16]);
    ui->Dark->setText(str[17]);
    ui->Info->setTitle(str[18]);
    ui->ShowInfo->setText(str[19]);
    ui->Binds->setText(str[20]);
}
