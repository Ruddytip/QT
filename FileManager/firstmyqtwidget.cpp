...
FirstMyQtWidget::FirstMyQtWidget(QWidget *parent) : QWidget(parent), model(nullptr) {
...
void FirstMyQtWidget::rebuildModel(QString str) {
    ...
    items.append(new
    QStandardItem(QIcon(QApplication::style()->standardIcon(QStyle::SP_DriveHDIcon)), str));
